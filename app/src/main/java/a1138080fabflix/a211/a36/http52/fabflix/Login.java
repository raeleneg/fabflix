...
public class Login extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     */
    private static final String[] DUMMY_CREDENTIALS = new String[]{ //NOTE: Conncet to database to see if in mySQL
            "19:root", "classta@course.edu:classta"
    };
    /**
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                userJSON.accumulate("email", mEmail);
                userJSON.accumulate("password", mPassword);
